...
# Original source codes from Shuichi Akizuki, Chukyo Univ.
# Email: s-akizuki@sist.chukyo-u.ac.jp
# Modified by Seunhyeok Back, GIST
# Email": shback@gm.gist.ac.kr
...
def scaleCloud( cloud_in, scale ):
    ...
    cloud_out.colors = cloud_in.colors
